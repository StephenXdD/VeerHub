...
def crop_pdf(input_pdf_path, output_pdf_path):
    ...
    print(f"Searching for current question patterns: {current_question_patterns}")
    ...
    for page_num in range(doc.page_count):
        ...
        try:
            ...
            print(f"Error processing page {page_num + 1} of {input_pdf_path}: {e}")
    ...
    try:
        ...
        cropped_pdf.close()
        print(f"Saved cropped PDF: {output_pdf_path}")
    except OSError as e:
