...
def find_question_number_in_area(page, search_area=75):
    """Searches for question numbers within the leftmost 70 points of the page."""
...
def split_pdf_into_questions(input_pdf_path, output_dir, max_questions=12):
    ...
    try:
        ...
        last_saved_page = -1      # Track last saved page to avoid duplicates
...
output_base_folder = "output_questions"
